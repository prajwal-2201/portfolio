        ...
        <div className="max-w-7xl mx-auto px-6 md:px-12 flex justify-between items-center">
          ...
          <a href="#hero" className="flex items-center gap-3 group">
            ...
            <div className="leading-none">
              ...
              <div className="text-[9px] text-slate-500 tracking-[0.25em] uppercase">Digital Forensics Analyst</div>
            </div>
          </a>
          ...
          <div className="hidden lg:flex items-center gap-1">
            ...
            <a
              ...
              className="ml-4 px-5 py-2 bg-white text-black text-[10px] font-bold uppercase tracking-[0.2em] rounded-full hover:bg-slate-200 transition-colors"
            >
              Resume ↗
            </a>
          </div>
